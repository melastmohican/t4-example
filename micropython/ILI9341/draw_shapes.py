...
display_spi = SPI(0, baudrate=51200000, sck=Pin(2), mosi=Pin(3), miso=Pin(0))
# Set up display
display = Display(display_spi, dc=Pin(18), cs=Pin(20), rst=Pin(19), width=320, height=240, rotation=90)
