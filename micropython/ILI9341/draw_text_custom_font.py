...
# Set up display
display = Display(display_spi, dc=Pin('D10'), cs=Pin('D9'), rst=Pin('D8'), width=320, height=240, rotation=90)
...
def draw_text():
    ...
    display.draw_text(0, 0, 'Pico says hello!', unispace_font, black_color, white_color)
